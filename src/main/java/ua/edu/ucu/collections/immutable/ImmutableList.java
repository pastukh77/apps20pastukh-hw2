...
// У результаті змін, що призводять
// на модифікації (зміну стану) колекції
...
public interface ImmutableList {
    ...
    Object get(int index); //повертає елемент за
    // індексом, та кидає виключну ситуацію, якщо
    // індекс виходить за межі колекції

    ImmutableList remove(int index); //видаляє
    // елемент за індексом, та кидає виключну
    ...
    int indexOf(Object e); //шукає індекс
    // елемента (повертає індекс першого
    ...
    boolean isEmpty(); //якщо у колеції
    // нема елементів то повертає true

    Object[] toArray(); //перетворює
    // колекцію до масиву обєктів

    @Override
    String toString(); //повертає рядок,
    // де через кому відображаютсься
    // елементи колекції
}
