...
public class ImmutableLinkedListTest {
    ...
    private ImmutableLinkedList simple;
    private ImmutableLinkedList empty;
    private ImmutableLinkedList oneElement;

    @Before
    public void init() {
        Object[] oneEl = new Object[]{1};
        Object[] simpleArr = new Object[]{1, 2, 3, 4, 5};
        simple = new ImmutableLinkedList(simpleArr);
        empty = new ImmutableLinkedList();
        oneElement = new ImmutableLinkedList(oneEl);
    }
    ...
    @Test(expected = IndexOutOfBoundsException.class)
    public void testRemoveFirstWithEmpty() {
        empty.removeFirst();
    }

    @Test(expected = IndexOutOfBoundsException.class)
    public void testRemoveLastWithEmpty() {
        empty.removeLast();
    }
    ...
    @Test
    public void testIndexOfWithEmpty() {
        int expected = -1;
        int actual = empty.indexOf(77);
        assertEquals(expected, actual);
    }
    ...
    @Test
    public void testAddFirstWithOneElement() {
        Object[] expected = new Object[]{2, 1};
        assertArrayEquals(expected, oneElement.addFirst(2).toArray());
    }

    @Test
    public void testAddLastWithOneElement() {
        Object[] expected = new Object[]{1, 2};
        assertArrayEquals(expected, oneElement.addLast(2).toArray());
    }

    @Test
    public void testGetFirstWithOneElement() {
        Object expected = 1;
        Object actual = oneElement.getFirst();
        assertEquals(expected, actual);
    }

    @Test
    public void testGetLastWithOneElement() {
        Object expected = 1;
        Object actual = oneElement.getLast();
        assertEquals(expected, actual);
    }
    ...
    public void testRemoveFirstWithOneElement() {
        Object[] expected = new Object[]{};
        Object[] actual = oneElement.removeFirst().toArray();
        assertArrayEquals(expected, actual);
    }
    ...
    public void testRemoveLastWithOneElement() {
        Object[] expected = new Object[]{};
        Object[] actual = oneElement.removeLast().toArray();
        assertArrayEquals(expected, actual);
    }
    ...
    @Test
    public void testAddFirstWithSimple() {
        Object[] expected = new Object[]{77, 1, 2, 3, 4, 5};
        assertArrayEquals(expected, simple.addFirst(77).toArray());
    }

    @Test
    public void testAddLastWithOneSimple() {
        Object[] expected = new Object[]{1, 2, 3, 4, 5, 77};
        assertArrayEquals(expected, simple.addLast(77).toArray());
    }

    @Test
    public void testGetFirstWithSimple() {
        Object expected = 1;
        Object actual = simple.getFirst();
        assertEquals(expected, actual);
    }

    @Test
    public void testGetLastWithSimple() {
        Object expected = 5;
        Object actual = simple.getLast();
        assertEquals(expected, actual);
    }
    ...
    @Test
    public void testRemoveFirstWithSimple() {
        Object[] expected = new Object[]{2, 3, 4, 5};
        Object[] actual = simple.removeFirst().toArray();
        assertArrayEquals(expected, actual);
    }

    @Test
    public void testRemoveLastWithSimple() {
        Object[] expected = new Object[]{1, 2, 3, 4};
        Object[] actual = simple.removeLast().toArray();
        assertArrayEquals(expected, actual);
    }
